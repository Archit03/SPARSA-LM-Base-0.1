...
def main():
    ...
    try:
        ...
        parser.add_argument(
            '--dataset-config',
            type=str,
            default=r'C:\Users\ASUS\Desktop\LuminaLM-base-0.1\config\dataset_config.yaml',
            help='Path to dataset configuration file'
        )
        parser.add_argument(
            '--cache-dir',
            type=str,
            default=r'C:\Users\ASUS\Desktop\LuminaLM-base-0.1\data\processed\cache',
            help='Directory for caching datasets'
        )
        parser.add_argument(
            '--log-dir',
            type=str,
            default=r'C:\Users\ASUS\Desktop\LuminaLM-base-0.1\logs',
        ...
        # Set up logging with the new log directory
